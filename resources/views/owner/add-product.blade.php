                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="mb-3">
                            ...
                            <textarea name="condition" id="condition" cols="5" rows="5" class="form-control @error('condition') is-invalid @enderror">{{ old('condition') }}</textarea>
                            @error('condition')
                                <span class="invalid-feedback" role="alert">
                                    {{ $message }}
                                </span>
                    ...
                    <div class="col-6">
                        <div class="mb-3">
                            ...
                            <textarea name="address" id="address" cols="5" rows="5" class="form-control @error('address') is-invalid @enderror">{{ old('address') }}</textarea>
                            @error('address')
                                <span class="invalid-feedback" role="alert">
                                    {{ $message }}
                                </span>
